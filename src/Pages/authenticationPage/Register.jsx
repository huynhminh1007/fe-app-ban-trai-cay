...
function Register() {
  ...
  const handleRegisterSubmit = (e) => {
    ...
    if (!regEmail || !regPassword || !regDob || !regPhone) {
      alert(
        "Vui lòng nhập đầy đủ thông tin: Email, Mật khẩu, Ngày sinh và SĐT!",
      );
      return;
    }
  ...
  const handleLoginSubmit = (e) => {
    ...
    // Check thông tin
    if (
      loginEmail === checkLogin.email &&
      loginPassword === checkLogin.password
    ) {
      ...
      <div className={`auth-container ${isActive ? "active" : ""}`}>
          ...
          <form onSubmit={handleRegisterSubmit}>
            ...
            <div className="input-box">
              <DatePicker
                ...
                required
              />
              <i style={{ pointerEvents: "none", zIndex: 10 }}>
        ...
        <div className="toggle-box">
          <div className="toggle-box-panel left">
            ...
            <button
              type="button"
              className="btn-register register-btn register-btn-2"
          ...
          <div className="toggle-box-panel right">
            ...
            <button
              type="button"
              className="btn-register login-btn login-btn-2"
