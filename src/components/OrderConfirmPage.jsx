        ...
        <div className="order-confirm-page">
            ...
            <div className="confirm-container">
                ...
                <div className="confirm-box">
                    ...
                    <p><b>Họ tên:</b> {orderInfo.name}</p>
                    <p><b>SĐT:</b> {orderInfo.phone}</p>
                    <p><b>Email:</b> {orderInfo.email || "Không có"}</p>
                    <p>
                        <b>Địa chỉ:</b> {orderInfo.address} – {orderInfo.quan} – {orderInfo.tinh}
                    </p>
                    <p>
                        <b>Vận chuyển:</b>{" "}
                        {orderInfo.shipMethod === "viettel"
                            ? "Viettel Post"
                            : "Xe khách"}
                    </p>
                    {orderInfo.note && (
                        <p><b>Ghi chú:</b> {orderInfo.note}</p>
                    )}
                </div>
