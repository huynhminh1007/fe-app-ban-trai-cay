...
const ProductInfo = ({ product }) => {
  ...
  return (
    <div className="product-info-wrapper">
      ...
      <div className="p-price">{formatVND(product.prices.price)}</div>
        ...
        <table className="specs-table">
          <tbody>
            ...
            <tr>
              <td>Đất trồng</td>
              <td>
                Thích nghi trên nhiều loại đất có độ PH từ 5.5 – 6.5, độ mặn
                &lt;0.3 phần ngàn
              </td>
            </tr>
          </tbody>
      ...
      <div className="product-meta-data">
        <p className="meta-row">
          ...
          {isOutOfStock ? (
            ...
            <span style={{ color: "#21c42a", fontWeight: "bold" }}>
              Còn hàng : {stockCount}
            </span>
          )}
        </p>
